...
struct WWISERESOURCELOADER_API FWwiseLoadedMedia
{
	FWwiseLoadedMedia(const FWwiseMediaCookedData& InMedia) :
...
using FWwiseLoadedMediaList = TDoubleLinkedList<FWwiseLoadedMedia>;
