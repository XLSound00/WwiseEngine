...
struct WWISERESOURCELOADER_API FWwiseLoadedEvent
{
	FWwiseLoadedEvent(const FWwiseLocalizedEventCookedData& InEvent, const FWwiseLanguageCookedData& InLanguage) :
...
using FWwiseLoadedEventList = TDoubleLinkedList<FWwiseLoadedEvent>;
