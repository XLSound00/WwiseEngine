...
struct WWISERESOURCELOADER_API FWwiseLoadedInitBank
{
	FWwiseLoadedInitBank(const FWwiseInitBankCookedData& InInitBank) :
...
using FWwiseLoadedInitBankList = TDoubleLinkedList<FWwiseLoadedInitBank>;
