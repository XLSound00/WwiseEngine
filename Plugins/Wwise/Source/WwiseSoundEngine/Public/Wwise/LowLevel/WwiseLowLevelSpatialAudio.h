...
class WWISESOUNDENGINE_API FWwiseLowLevelSpatialAudio
{
public:
	static FWwiseLowLevelSpatialAudio* Get()
	{
	...
	AKRESULT Init(const AkSpatialAudioInitSettings& in_initSettings);
	...
	struct WWISESOUNDENGINE_API FReverbEstimation
	{
		////////////////////////////////////////////////////////////////////////
