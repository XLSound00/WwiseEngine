...
class WWISESOUNDENGINE_API FWwiseLowLevelSoundEngine
{
public:
	static FWwiseLowLevelSoundEngine* Get()
	{
	...
	/// the sound engine since initialization. 
	/// \return Sample count.
	AkUInt64 GetSampleTick();

	struct WWISESOUNDENGINE_API FQuery
	{
		////////////////////////////////////////////////////////////////////////
		/// @name Game Objects
		//@{
		...
		AKRESULT GetMaxRadius(
			AK::SoundEngine::Query::AkRadiusList& io_RadiusList	///< List that will be filled with AK::SoundEngine::Query::GameObjDst objects.
			);
	...
	struct WWISESOUNDENGINE_API FAkAudioInputPlugin
	{
