...
void UAkSwitchValue::LoadGroupValue(bool bReload)
{
...
void UAkSwitchValue::Serialize(FArchive& Ar)
{
	...
	if (ResourceCooker->PrepareCookedData(CookedDataToArchive, GetValidatedInfo(GroupValueInfo), EWwiseGroupType::Switch))
	{
